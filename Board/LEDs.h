...
#include <avr/io.h>
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			...
			#define LEDS_GREEN	LEDS_LED1
			#define LEDS_BLUE	LEDS_LED2
			#define LEDS_YELLOW	LEDS_LED3
			#define LEDS_RED	LEDS_LED4

			/** LED mask for the first LED on the board. */
			#define LEDS_LED1	PIN0_bm        // TODO: Add mask for first board LED here

			/** LED mask for the second LED on the board. */
			#define LEDS_LED2	PIN1_bm        // TODO: Add mask for second board LED here

			/** LED mask for the second LED on the board. */
			#define LEDS_LED3	PIN2_bm        // TODO: Add mask for second board LED here

			/** LED mask for the fourth LED on the board. */
			#define LEDS_LED4	PIN3_bm        // TODO: Add mask for fourth board LED here
		...
		/* Inline Functions: */
			...
			{
				PORTLED.DIRSET=LEDS_ALL_LEDS;
				PORTLED.OUTCLR=LEDS_ALL_LEDS;
			}

			static inline void LEDs_Disable(void)
			{
				PORTLED.DIRCLR=LEDS_ALL_LEDS;
				PORTLED.OUTCLR=LEDS_ALL_LEDS;
			}
			...
			static inline uint8_t LEDs_GetLEDs(void)
			{
				...
				return (PORTLED.OUT & LEDS_ALL_LEDS);
			}
		#endif
