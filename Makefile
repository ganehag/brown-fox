...
#LUFA_OPTS += -D MAX_ENDPOINT_INDEX=4
LUFA_OPTS += -D USE_STATIC_OPTIONS="(USB_DEVICE_OPT_FULLSPEED | USB_OPT_RC32MCLKSRC | USB_OPT_BUSEVENT_PRIHIGH)"
#LUFA_OPTS += -D USE_STATIC_OPTIONS="( USB_DEVICE_OPT_LOWSPEED|USB_OPT_PLLCLKSRC | USB_OPT_BUSEVENT_PRIHIGH)"
